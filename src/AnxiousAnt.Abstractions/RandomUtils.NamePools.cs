...
partial class RandomUtils
{
    // List of adjectives and surnames copied from
    // https://github.com/moby/moby/blob/13879e7b496d14fb0724719c49c858731c9e7f60/pkg/namesgenerator/names-generator.go

    private static readonly string[] AdjectivesPool =
    [
        "admiring",
        "adoring",
        "affectionate",
    ...
    private static readonly string[] SurnamesPool =
    [
